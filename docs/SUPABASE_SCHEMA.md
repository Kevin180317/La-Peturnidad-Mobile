...
> Generated on 2026-06-20. 19 migrations applied.
...
RETURNS boolean
LANGUAGE sql
SECURITY DEFINER  -- runs as owner, breaks RLS recursion
STABLE
AS $$
  SELECT EXISTS (
...
| Policy | Command | Rule |
|---|---|---|
| Anyone can view profiles | SELECT | `true` (public profiles for the community) |
